...
def apply_app_style():
    ...
    st.markdown(
        ...
        [data-testid="stSidebar"] {
            ...
            box-shadow: 6px 0 18px rgba(31, 41, 55, 0.03);
        }
        ...
        .workflow-step:first-child .workflow-index {
            background: #d9efe6;
            color: #1f5f53;
        }
        ...
        .stButton > button {
            ...
            border-color: #245f54;
            font-weight: 780;
            box-shadow: 0 5px 12px rgba(36, 95, 84, 0.18);
        }
